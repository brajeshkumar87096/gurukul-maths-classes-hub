    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
      ...
      <div className="mt-8 pt-6 border-t border-gray-200">
        ...
        <div className="space-y-3">
          <a href="tel:8709601984" className="flex items-center text-gray-700 hover:text-gurukul-purple">
            <Phone className="h-5 w-5 mr-2" />
            <span>8709601984</span>
          </a>
          <a href="https://wa.me/9523085735" className="flex items-center text-gray-700 hover:text-gurukul-purple">
            <MessageCircle className="h-5 w-5 mr-2" />
            <span>WhatsApp: 9523085735</span>
          </a>
